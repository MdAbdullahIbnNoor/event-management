...
const SignUp = () => {
  ...
  return (
    <div className=' lg:my-[250px] max-h-64'>
      <h2 className='text-5xl font-bold text-center my-10 text-gray-700'>Please <span className='text-blue-700'>Register</span></h2>
      <div className='flex flex-col-reverse lg:flex-row items-center max-w-screen-2xl justify-around mx-auto'>
        ...
        <div>
          <img className='mx-auto w-4/5 lg:w-full mb-8 lg:mb-0' src={image} alt="" />
        </div>
      </div>
      <ToastContainer />
    </div>
